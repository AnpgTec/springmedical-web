...
mkdirSync("scripts/seed-b64-one", { recursive: true });
...
const remaining = [
  "centella-anti-inflammatory-repair-serum",
  "fast-growing-bamboo-serum",
  "hydra-magnet-mask",
  "dry-or-normal-skin-kit",
  "hydrating-firming-mask",
  "rapid-recovery-treatment-kit",
  "lytic-gel-cleanser",
  "gentle-cream-cleanser",
  "normal-or-combination-skin-kit",
...
for (const slug of remaining) {
  ...
  writeFileSync(`scripts/seed-b64-one/${slug}.sql`, wrapper, "utf8");
  console.log(slug, wrapper.length);
}
