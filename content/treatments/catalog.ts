...
<li>Return promptly if swelling persists, or if blisters, marked pain or rebound darkening appear.</li>
  ...
  },
  {
    ...
    bodyHtml: { "zh-HK": `<h3>療程介紹</h3><p>BTL Ultra Femme 360 由英國頂尖醫療儀器生產商 BTL 研發，擁有美國 FDA 及歐盟 CE 安全認證，以即棄式治療棒加上單極射頻及超聲波，作 360 度零盲點治療，熱能能傳遞到深層皮下組織層，刺激及促進骨膠原蛋白和彈力蛋白的增生，緊緻陰部之餘，更增加陰部肌肉彈性。</p><h3>療程效果</h3><p>Ultra Femme 360 以單極射頻及超聲波能刺激陰道內壁，刺激膠原蛋白自然增生，陰道壁變厚，改善陰部三大問題，美白外陰變得粉嫩﹑緊緻修形，收緊內陰﹑回復濕潤及彈性，強化骨盤改善尿滲﹑失禁，急救或長期保養皆宜。</p><h3>療程感受</h3><p>療程期間無痛無創，不會造成傷口，只有少量溫熱的感覺。完成首次療程後，膠原已開始增生及變厚，會開始感到陰道內壁感覺已與療程前不同。</p><h3>療程次數</h3><p>治療過程大約需時 8 分鐘，一次已見明顯緊緻效果，建議一年三次，之後再按年齡或情況需要保養。</p><h3>療程優點</h3><p>無創無痛地解決陰部困擾，重拾健康身體和愉快性生活。</p><h3>適合人士</h3><ul><li>計劃懷孕的女士</li><li>更年期症狀女士</li><li>產後保養的媽媽</li><li>輕熟女士</li><li>關注陰部健康的女士</li></ul>`, "zh-CN": `<h3>疗程介绍</h3><p>BTL Ultra Femme 360 由英国顶尖医疗仪器生产商 BTL 研发，拥有美国 FDA 及欧盟 CE 安全认证，以即弃式治疗棒加上单极射频及超声波，作 360 度零盲点治疗，热能能传递到深层皮下组织层，刺激及促进骨胶原蛋白和弹力蛋白的增生，紧致阴部之余，更增加阴部肌肉弹性。</p><h3>疗程效果</h3><p>Ultra Femme 360 以单极射频及超声波能刺激阴道内壁，刺激胶原蛋白自然增生，阴道壁变厚，改善阴部三大问题，美白外阴变得粉嫩﹑紧致修形，收紧内阴﹑回复湿润及弹性，强化骨盘改善尿渗﹑失禁，急救或长期保养皆宜。</p><h3>疗程感受</h3><p>疗程期间无痛无创，不会造成伤口，只有少量温热的感觉。完成首次疗程后，胶原已开始增生及变厚，会开始感到阴道内壁感觉已与疗程前不同。</p><h3>疗程次数</h3><p>治疗过程大约需时 8 分钟，一次已见明显紧致效果，建议一年三次，之后再按年龄或情况需要保养。</p><h3>疗程优点</h3><p>无创无痛地解决阴部困扰，重拾健康身体和愉快性生活。</p><h3>适合人士</h3><ul><li>计划怀孕的女士</li><li>更年期症状女士</li><li>产后保养的妈妈</li><li>轻熟女士</li><li>关注阴部健康的女士</li></ul>`, en: `<h3>About the treatment</h3><p>BTL Ultra Femme 360 is developed by BTL, a leading UK medical device manufacturer, and holds US FDA and EU CE safety certification. Using a disposable treatment applicator together with monopolar radiofrequency and ultrasound, it delivers 360-degree, zero-blind-spot treatment. Heat is transmitted to the deep subcutaneous tissue layer, stimulating and promoting the production of collagen and elastin, tightening the intimate area while also increasing muscle elasticity.</p><h3>Treatment results</h3><p>Ultra Femme 360 uses monopolar radiofrequency and ultrasound to stimulate the vaginal wall, encouraging natural collagen production so that the vaginal wall thickens. It addresses three major intimate concerns: brightening the outer vulva to a more delicate, rosy tone; firming and reshaping, tightening the inner vagina and restoring moisture and elasticity; and strengthening the pelvic floor to improve leakage and incontinence. Suitable for both short-term care and long-term maintenance.</p><h3>How it feels</h3><p>The treatment is painless and non-invasive, with no wounds created — only a mild sensation of warmth. After the first session, collagen has already begun to increase and thicken, and the vaginal wall will start to feel different from before treatment.</p><h3>Number of sessions</h3><p>Each session takes about 8 minutes. Noticeable tightening can already be seen after one treatment. Three sessions a year are recommended, with further maintenance according to age or individual needs.</p><h3>Advantages</h3><p>Addresses intimate concerns without surgery or pain, helping restore a healthy body and a more enjoyable sex life.</p><h3>Who it is for</h3><ul><li>Women planning pregnancy</li><li>Women with menopausal symptoms</li><li>Mothers seeking postpartum care</li><li>Women in their mature years</li><li>Women concerned about intimate health</li></ul>` },
    points: [
  ...
  },
  {
    ...
    bodyHtml: { "zh-HK": `<h3>療程介紹</h3><p>全新第四代 BTL EXILIS Ultra 360 為非入侵性療程，由英國 BTL 研發，歐洲原廠製造，以全球唯一 FDA 認證超聲波結合單極射頻技術，刺激眼底膠原蛋白及彈力蛋白增生，緊緻眼部肌膚，阻截眼周老化問題，加強眼皮下組織承托力撫平眼紋，回復光滑緊緻﹑逆轉眼齡。</p><h3>療程效果</h3><p>加速眼周循環﹑改善浮腫，增厚膠原保護層遮蓋血管﹑淡化黑眼圈﹑撫平眼紋，提拉眼部輪廓，回復年輕神采。</p><h3>療程感受</h3><p>BTL Exilis Ultra 360 超頻技術能滲透眼底，療程時眼周會感到熱力，溫熱感能令眼周舒緩放鬆。</p><h3>療程次數</h3><p>療程初期建議第一個月每週進行一次，第二個月可調整為每三週進行一次，具體療程頻率將根據個人情況及醫生評估而定。</p><h3>療程優點</h3><p>全球唯一結合單極射頻及超聲波技術，能量 360 度層層滲透肌底，均勻分佈，深入眼周每吋肌膚刺激眼底膠原蛋白及彈力蛋白增生，激活兩倍膠原。舒適地解決四大眼周問題：提升﹑緊緻﹑減淡黑眼圈﹑增加眼部承托力阻截眼袋形成，非入侵性﹑無痛感﹑無恢復期而且效果持久，完成療程後可立即化妝。</p>`, "zh-CN": `<h3>疗程介绍</h3><p>全新第四代 BTL EXILIS Ultra 360 为非入侵性疗程，由英国 BTL 研发，欧洲原厂制造，以全球唯一 FDA 认证超声波结合单极射频技术，刺激眼底胶原蛋白及弹力蛋白增生，紧致眼部肌肤，阻截眼周老化问题，加强眼皮下组织承托力抚平眼纹，回复光滑紧致﹑逆转眼龄。</p><h3>疗程效果</h3><p>加速眼周循环﹑改善浮肿，增厚胶原保护层遮盖血管﹑淡化黑眼圈﹑抚平眼纹，提拉眼部轮廓，回复年轻神采。</p><h3>疗程感受</h3><p>BTL Exilis Ultra 360 超频技术能渗透眼底，疗程时眼周会感到热力，温热感能令眼周舒缓放松。</p><h3>疗程次数</h3><p>疗程初期建议第一个月每周进行一次，第二个月可调整为每三周进行一次，具体疗程频率将根据个人情况及医生评估而定。</p><h3>疗程优点</h3><p>全球唯一结合单极射频及超声波技术，能量 360 度层层渗透肌底，均匀分布，深入眼周每吋肌肤刺激眼底胶原蛋白及弹力蛋白增生，激活两倍胶原。舒适地解决四大眼周问题：提升﹑紧致﹑减淡黑眼圈﹑增加眼部承托力阻截眼袋形成，非入侵性﹑无痛感﹑无恢复期而且效果持久，完成疗程后可立即化妆。</p>`, en: `<h3>About the treatment</h3><p>The new fourth-generation BTL EXILIS Ultra 360 is a non-invasive treatment developed by BTL in the UK and manufactured in Europe. It uses the world’s only FDA-certified combination of ultrasound and monopolar radiofrequency technology to stimulate collagen and elastin production in the deeper periocular tissue, firming the eye-area skin, intercepting periocular ageing, strengthening support in the subcutaneous tissue under the eyes to smooth eye lines, restoring smoothness and firmness, and reversing the apparent age of the eyes.</p><h3>Treatment results</h3><p>Accelerates periocular circulation and improves puffiness; thickens the collagen protective layer to conceal blood vessels; fades dark circles; smooths eye lines; lifts the eye contour; and restores a youthful look.</p><h3>How it feels</h3><p>BTL Exilis Ultra 360 ultra-frequency technology can penetrate to the deeper periocular tissue. During treatment the eye area will feel heat; the warmth helps the periocular area feel soothed and relaxed.</p><h3>Number of sessions</h3><p>During the initial course, one session per week is recommended in the first month; from the second month, this may be adjusted to once every three weeks. The exact frequency will depend on your individual condition and your doctor’s assessment.</p><h3>Advantages</h3><p>The world’s only combination of monopolar radiofrequency and ultrasound technology. Energy penetrates the deeper layers of the skin in 360 degrees, distributed evenly, reaching every inch of periocular skin to stimulate collagen and elastin production and activate twice the collagen. Comfortably addresses four major periocular concerns: lifting, firming, fading dark circles, and increasing support under the eyes to intercept the formation of eye bags. Non-invasive, painless, with no downtime and lasting results; make-up may be applied immediately after treatment.</p>` },
    points: [
    ...
    faqs: [
      ...
      { q: { "zh-HK": `建議做多少次 Exilis Ultra 360？`, "zh-CN": `建议做多少次 Exilis Ultra 360？`, en: `How many Exilis Ultra 360 sessions are recommended?` }, a: { "zh-HK": `療程初期建議第一個月每週進行一次，第二個月可調整為每三週進行一次，具體療程頻率將根據個人情況及醫生評估而定。`, "zh-CN": `疗程初期建议第一个月每周进行一次，第二个月可调整为每三周进行一次，具体疗程频率将根据个人情况及医生评估而定。`, en: `One session per week in the first month, then possibly once every three weeks from the second month — frequency is set according to your condition and your doctor’s assessment.` } },
  ...
  },
  {
    ...
    bodyHtml: { "zh-HK": `<p>BTL Emtone 超頻緊緻膠原槍以全球唯一美國FDA認證超聲波結合單極射頻技術，提升2倍膠原蛋白360˚環迴零盲點探頭，緊緻肌膚底層老化膠原，有效激發膠原自生，非入侵性無恢復期。</p>`, "zh-CN": `<p>BTL Emtone 超频紧致胶原枪以全球唯一美国FDA认证超声波结合单极射频技术，提升2倍胶原蛋白360˚环回零盲点探头，紧致肌肤底层老化胶原，有效激发胶原自生，非入侵性无恢复期。</p>`, en: `<p>The BTL Emtone ultra-frequency collagen gun uses the world’s only US FDA-certified combination of ultrasound and monopolar radiofrequency technology, boosting collagen up to 2 times. With a 360˚ circulating, zero-blind-spot probe, it firms ageing collagen in the deeper layers of the skin, effectively stimulating the skin’s own collagen production — non-invasive, with no downtime.</p>` },
    points: [
    ...
    image: "/images/btl-service-2.png",
    faqs: [
...
<h3>疗程频率与注意事项</h3>
<ul><li>效果可维持约 12 个月，建议每隔 9 个月至 1 年再做一次</li><li>非入侵性，无须恢复期，可即时正常活动</li><li>术后加强保湿与防晒，7 日内暂停含酸类、去角质或美白活性成分的产品</li></ul>`, en: `<p>Thermage® FLX is a US FDA-cleared non-invasive skin-tightening treatment. It uses patented monopolar radiofrequency technology together with the AccuREP™ real-time regulation system to deliver heat in a 3D volumetric manner to the dermis, helping stimulate progressive collagen production, improve skin laxity and refine contour lines. No surgery is required, and there is generally no specific downtime.</p>
<h3>Treatment principle: 3D volumetric heating</h3>
<p>Combining monopolar radiofrequency with intelligent micro-adjustment technology, energy is delivered evenly from the outside in to the dermis and subcutaneous tissue.</p>
<p><strong>AccuREP™ real-time regulation technology</strong>: a fifth-generation exclusive technology that measures local skin impedance before each energy pulse and micro-adjusts the radiofrequency output in real time, ensuring energy is delivered evenly.</p>
<p><strong>3D volumetric heating mechanism</strong>: radiofrequency energy heats collagen-rich tissue over a three-dimensional, large-area field, helping stimulate collagen contraction and initiate subsequent remodelling.</p>
<p><strong>All-round vibration and soothing cryogen</strong>: the tip features Comfort Pulse Technology and cryogen spray, protecting the epidermis while heat is delivered and reducing discomfort during treatment.</p>
<h3>Site-specific treatment tips</h3>
<p>A range of dedicated intelligent tips is available. The physician selects the appropriate tip according to the client’s skin condition and contour needs.</p>
<p><strong>Face and jawline (Purple Diamond tip)</strong>: the signature fifth-generation Purple Diamond tip, with a larger coverage area than the previous generation, helping treat cheek laxity and jawline contour more evenly.</p>
<ul><li>Helps shorten treatment time</li><li>Improves the appearance of the apple cheeks and nasolabial folds</li><li>Refines the definition of the jawline</li></ul>
<p><strong>Delicate periocular skin (Jade Eye tip)</strong>: designed for the thinner skin around the eyes, with a shallower heating depth, helping gently tighten the upper and lower eyelid skin. FDA-cleared for use on the upper and lower eyelids.</p>
<ul><li>FDA-cleared for use on the upper and lower eyelids</li><li>Helps soften the appearance of periocular fine lines</li><li>Improves periocular skin laxity</li></ul>
<p><strong>Large body areas (Imperial Jade tip)</strong>: the largest tip surface area, suitable for treating larger areas of lax body skin, such as the abdomen or arms.</p>
<ul><li>Improves abdominal skin laxity</li><li>Firms the arms (Bye-bye arms) and thigh contour</li><li>Helps smooth the surface texture of body skin</li></ul>
<h3>Five key benefits</h3>
<ul><li>Immediate skin tightening and lifting: improves nasolabial folds, double chin and jawline laxity</li><li>Stimulates collagen production</li><li>Improves wrinkles and rough skin texture</li><li>Firms the periocular skin (the only treatment FDA-cleared for the upper eyelid)</li><li>Improves neck, jawline and body skin laxity</li></ul>
<h3>Treatment frequency and precautions</h3>
<ul><li>Results may last about 12 months; a further session every 9 months to 1 year is recommended</li><li>Non-invasive, with no downtime; normal activity can resume immediately</li><li>After treatment, increase hydration and sun protection, and pause products containing acids, exfoliants or brightening actives for 7 days</li></ul>` },
    points: [
    ...
    image: "/images/thermage-flx-main.png",
    faqs: [
  ...
  },
  {
    ...
    bodyHtml: { "zh-HK": `<p>CO₂ Laser（二氧化碳激光）屬於剝脫性（ablative）氣體激光，波長為 10,600 nm，對皮膚組織中的水分子具備極高親和力。當激光光束投射至治療區域時，水分子瞬間吸收能量並產生熱能，導致目標組織精確氣化（vaporization），同時向周邊傳遞餘熱，誘發膠原蛋白即時收縮與彈性纖維重組。</p><p>其核心功效可歸納為以下五大層面：</p><h3>（1）表層組織重塑</h3><p>透過移除老化、受損或病變的表皮層，促進新生上皮細胞遷移與覆蓋，使膚質更趨平滑細緻，有效改善粗糙、暗啞及角質堆積問題。</p><h3>（2）皺紋與細紋改善</h3><p>熱能刺激真皮層膠原蛋白變性與收縮，產生即時的緊緻效應；術後中長期則透過膠原新生（neocollagenesis）機制，逐步填補動態及靜態皺紋，尤其對眼周、口周細紋效果顯著。</p><h3>（3）凹陷性疤痕修復</h3><p>針對暗瘡疤痕、水痘疤或創傷性萎縮疤痕，激光能精確氣化疤痕組織的纖維化結構，同時誘導底部膠原重組與增生，使疤痕邊緣趨向平緩，恢復皮膚表面均勻度。</p><h3>（4）良性皮膚增生移除</h3><p>對脂溢性角化（老人斑）、汗管瘤、粟粒腫、日光性角化等表層良性病變，CO₂ Laser 能精準分層氣化移除，傷口癒合後由正常組織取代，達到清除病灶的效果。</p><h3>（5）整體膚質年輕化</h3><p>綜合上述作用，CO₂ Laser 能同時改善膚色不均、毛孔粗大、皮膚鬆弛及光老化表徵，達到全面性皮膚年輕化（skin rejuvenation）的目標，單次療程即可見顯著差異。</p>`, "zh-CN": `<p>CO₂ Laser（二氧化碳激光）属于剥脱性（ablative）气体激光，波长为 10,600 nm，对皮肤组织中的水分子具备极高亲和力。当激光光束投射至治疗区域时，水分子瞬间吸收能量并产生热能，导致目标组织精确气化（vaporization），同时向周边传递余热，诱发胶原蛋白即时收缩与弹性纤维重组。</p><p>其核心功效可归纳为以下五大层面：</p><h3>（1）表层组织重塑</h3><p>透过移除老化、受损或病变的表皮层，促进新生上皮细胞迁移与覆盖，使肤质更趋平滑细致，有效改善粗糙、暗哑及角质堆积问题。</p><h3>（2）皱纹与细纹改善</h3><p>热能刺激真皮层胶原蛋白变性与收缩，产生即时的紧致效应；术后中长期则透过胶原新生（neocollagenesis）机制，逐步填补动态及静态皱纹，尤其对眼周、口周细纹效果显著。</p><h3>（3）凹陷性疤痕修复</h3><p>针对暗疮疤痕、水痘疤或创伤性萎缩疤痕，激光能精确气化疤痕组织的纤维化结构，同时诱导底部胶原重组与增生，使疤痕边缘趋向平缓，恢复皮肤表面均匀度。</p><h3>（4）良性皮肤增生移除</h3><p>对脂溢性角化（老人斑）、汗管瘤、粟粒肿、日光性角化等表层良性病变，CO₂ Laser 能精准分层气化移除，伤口愈合后由正常组织取代，达到清除病灶的效果。</p><h3>（5）整体肤质年轻化</h3><p>综合上述作用，CO₂ Laser 能同时改善肤色不均、毛孔粗大、皮肤松弛及光老化表征，达到全面性皮肤年轻化（skin rejuvenation）的目标，单次疗程即可见显著差异。</p>`, en: `<p>CO₂ Laser (carbon dioxide laser) is an ablative gas laser with a wavelength of 10,600 nm and an exceptionally high affinity for water molecules in skin tissue. When the laser beam is projected onto the treatment area, water molecules instantly absorb the energy and generate heat, causing precise vaporization of the target tissue, while residual heat is transmitted to the surrounding area, inducing immediate collagen contraction and reorganisation of elastic fibres.</p><p>Its core benefits can be summarised in the following five aspects:</p><h3>(1) Superficial tissue remodelling</h3><p>By removing aged, damaged or diseased epidermis, it promotes the migration and coverage of new epithelial cells, making skin texture smoother and more refined, and effectively improving roughness, dullness and keratin build-up.</p><h3>(2) Improvement of wrinkles and fine lines</h3><p>Heat stimulates denaturation and contraction of dermal collagen, producing an immediate firming effect. Over the medium to long term after treatment, neocollagenesis gradually fills dynamic and static wrinkles, with particularly noticeable results for periocular and perioral fine lines.</p><h3>(3) Repair of atrophic scars</h3><p>For acne scars, chickenpox scars or traumatic atrophic scars, the laser can precisely vaporise the fibrotic structure of scar tissue while inducing collagen reorganisation and production at the base, so that scar edges become more gradual and surface evenness is restored.</p><h3>(4) Removal of benign skin growths</h3><p>For superficial benign lesions such as seborrheic keratosis (age spots), syringoma, milia and actinic keratosis, CO₂ Laser can precisely vaporise and remove them layer by layer. After wound healing, they are replaced by normal tissue, achieving clearance of the lesion.</p><h3>(5) Overall skin rejuvenation</h3><p>Combining the above actions, CO₂ Laser can simultaneously improve uneven tone, enlarged pores, skin laxity and signs of photoageing, achieving comprehensive skin rejuvenation. Significant difference can already be seen after a single session.</p>` },
    points: [
...
<ul><li>适用于较脆弱区域</li><li>有助改善表面纹理</li></ul>`, en: `<p>Ultherapy® PRIME is a US FDA-cleared non-invasive ultrasound lifting treatment. Equipped with DeepSEE™ real-time ultrasound imaging, it helps the physician visualise the deeper layers of the skin during treatment and deliver energy with precision to the SMAS fascial layer and the dermis, helping stimulate progressive regeneration of collagen and elastic fibres, improve skin laxity and reshape contours. No surgery is required, and there is generally no specific downtime.</p>
<h3>Treatment principle: the See-Plan-Treat approach</h3>
<p>Combining ultrasound imaging with micro-focused energy, heat is delivered to different skin layers.</p>
<p><strong>DeepSEE™ real-time imaging</strong>: the physician can monitor subcutaneous tissue in real time (to a depth of 6 mm), helping plan the energy path and avoid areas that should not be heated, improving the accuracy of treatment.</p>
<p><strong>MFU-V micro-focused energy</strong>: ultrasound energy is focused on the SMAS fascial layer and the dermis, producing fine thermal coagulation points that help initiate the tissue’s self-repair mechanism and provide structural support.</p>
<p><strong>Progressive collagen regeneration</strong>: heated tissue reorganises gradually; collagen production is a progressive process. The degree and timing of visible results vary with individual constitution; most people observe change within a few months.</p>
<h3>Layered treatment depths</h3>
<p>Tips of different treatment depths are available. The physician plans them according to the client’s skin thickness and degree of laxity.</p>
<p><strong>Targeting the SMAS fascial layer</strong>: energy is delivered to the deeper SMAS fascial layer, helping the visual lift of the jawline and overall facial contour.</p>
<ul><li>Targets deep structural support</li><li>Improves the definition of contour lines</li></ul>
<p><strong>Targeting the deep dermis</strong>: heating the deep dermis helps stimulate native collagen production and improve skin firmness.</p>
<ul><li>Helps collagen reorganisation</li><li>Optimises skin elasticity</li></ul>
<p><strong>Targeting superficial tissue</strong>: suitable for thinner skin or areas of superficial fine lines, such as around the eyes, for finer work.</p>
<ul><li>Suitable for more delicate areas</li><li>Helps improve surface texture</li></ul>` },
    points: [
    ...
    image: "/images/ultherapy-prime-main.png",
    faqs: [
  ...
  },
  {
    ...
    bodyHtml: { "zh-HK": `<p>針對脫髮、稀疏與頭皮養護的綜合方案，配合專業頭皮評估制定個人化護理，協助重建健康頭皮狀態。</p>`, "zh-CN": `<p>针对脱发、稀疏与头皮养护的综合方案，配合专业头皮评估制定个人化护理，协助重建健康头皮状态。</p>`, en: `<p>A comprehensive plan targeting hair loss, thinning and scalp care, with personalised protocols based on a professional scalp assessment, to help restore a healthy scalp condition.</p>` },
    points: [
  ...
  },
  {
    ...
    bodyHtml: { "zh-HK": `<p>能強效發揮刺激毛髮細胞，注滲精華技術養毛囊、不傷髮，有效延長毛囊生長週期；同時活化衰落細胞，增強血管輸養能力，加速頭髮生長，對抗規律性脫髮、持續性脫髮、雄激素性脫髮等問題。</p>`, "zh-CN": `<p>能强效发挥刺激毛发细胞，注渗精华技术养毛囊、不伤发，有效延长毛囊生长周期；同时活化衰落细胞，增强血管输养能力，加速头发生长，对抗规律性脱发、持续性脱发、雄激素性脱发等问题。</p>`, en: `<p>Powerfully stimulates hair cells. Essence-infusion technology nourishes the follicle without damaging the hair, effectively extending the follicle growth cycle; at the same time it activates declining cells, enhances vascular nutrient delivery, accelerates hair growth, and addresses patterned hair loss, ongoing shedding and androgenetic alopecia.</p>` },
    points: [
  ...
  },
  {
    ...
    bodyHtml: { "zh-HK": `<p>Restylane透明質酸在國際上多年來受美容專家信賴，以先進科技技術，製定高純度、安全的非動物透明質酸美容成份。Restylane透明質酸品牌對應不同類型的肌膚老化問題、輪廓提升、面形改善。</p>`, "zh-CN": `<p>Restylane透明质酸在国际上多年来受美容专家信赖，以先进科技技术，制定高纯度、安全的非动物透明质酸美容成份。Restylane透明质酸品牌对应不同类型的肌肤老化问题、轮廓提升、面形改善。</p>`, en: `<p>Restylane hyaluronic acid has been trusted by aesthetic specialists internationally for many years. With advanced technology, it is formulated as a high-purity, safe, non-animal hyaluronic acid aesthetic ingredient. The Restylane hyaluronic acid range addresses different types of skin ageing, contour lifting and facial-shape improvement.</p>` },
    points: [
  ...
  },
  {
    ...
    bodyHtml: { "zh-HK": `<p>Profhilo逆時針透明質酸由國際大型製藥公司IBSA研發，其專利技術蘊含極高濃度的純透明質酸，具提升活化膠原蛋白、彈性蛋白和日漸流失的脂肪細胞等美容效用，刺激12倍膠原增生。高效重塑組織，改善皮膚鬆弛。</p>`, "zh-CN": `<p>Profhilo逆时针透明质酸由国际大型制药公司IBSA研发，其专利技术蕴含极高浓度的纯透明质酸，具提升活化胶原蛋白、弹性蛋白和日渐流失的脂肪细胞等美容效用，刺激12倍胶原增生。高效重塑组织，改善皮肤松弛。</p>`, en: `<p>Profhilo time-reversing hyaluronic acid is developed by IBSA, a major international pharmaceutical company. Its patented technology contains an exceptionally high concentration of pure hyaluronic acid, with aesthetic effects including lifting and activating collagen, elastin and gradually depleting fat cells, stimulating 12 times collagen production. It efficiently remodels tissue and improves skin laxity.</p>` },
    points: [
  ...
  },
  {
    ...
    bodyHtml: { "zh-HK": `<p>Juvéderm透明質酸獲美國FDA、歐盟CE認證，全球唯一獲美國FDA認證在首次療程後能維持長達一年功效，屬非動物穩定性透明質酸，有效撫平肌膚皺紋、增強面形輪廓，同時改善皮膚鎖水度。</p>`, "zh-CN": `<p>Juvéderm透明质酸获美国FDA、欧盟CE认证，全球唯一获美国FDA认证在首次疗程后能维持长达一年功效，属非动物稳定性透明质酸，有效抚平肌肤皱纹、增强面形轮廓，同时改善皮肤锁水度。</p>`, en: `<p>Juvéderm hyaluronic acid is certified by the US FDA and EU CE — the only hyaluronic acid worldwide with US FDA certification that results can last up to one year after the first treatment. It is a non-animal stabilised hyaluronic acid that effectively smooths wrinkles, enhances facial contour, and at the same time improves the skin’s ability to lock in moisture.</p>` },
    points: [
  ...
  },
  {
    ...
    bodyHtml: { "zh-HK": `<p>Xeomin肉毒桿菌由德國Merz藥廠研發，獲美國FDA、歐盟CE認證。Xeomin是新一代純淨的肉毒桿菌，能有效阻斷引致肌肉收縮的神經細胞訊息傳遞功能，為減淡中至深度皺紋而設，使導致動態皺紋的肌肉得以放鬆，令面部線條變得更平滑，並防止新皺紋形成。</p>`, "zh-CN": `<p>Xeomin肉毒杆菌由德国Merz药厂研发，获美国FDA、欧盟CE认证。Xeomin是新一代纯净的肉毒杆菌，能有效阻断引致肌肉收缩的神经细胞讯息传递功能，为减淡中至深度皱纹而设，使导致动态皱纹的肌肉得以放松，令面部线条变得更平滑，并防止新皱纹形成。</p>`, en: `<p>Xeomin botulinum toxin is developed by Merz Pharmaceuticals in Germany and certified by the US FDA and EU CE. Xeomin is a new-generation purified botulinum toxin that effectively blocks the nerve-cell signalling that causes muscle contraction. It is designed to soften moderate-to-deep wrinkles, relaxing the muscles that produce dynamic lines so that facial contours become smoother, and helping prevent new wrinkles from forming.</p>` },
    points: [
  ...
  },
  {
    ...
    bodyHtml: { "zh-HK": `<p>Botox肉毒桿菌榮獲美國FDA認證，全球銷量高達一億瓶，是國際上極受信賴的美容選擇，肉毒桿菌能放鬆肌肉，療程只需10分鐘，達致去皺、面形改善、面形提升等美容效果，並可針對流汗劇烈人士，提供減少流汗治療。</p>`, "zh-CN": `<p>Botox肉毒杆菌荣获美国FDA认证，全球销量高达一亿瓶，是国际上极受信赖的美容选择，肉毒杆菌能放松肌肉，疗程只需10分钟，达致去皱、面形改善、面形提升等美容效果，并可针对流汗剧烈人士，提供减少流汗治疗。</p>`, en: `<p>Botox botulinum toxin is honoured with US FDA certification, with global sales of up to 100 million vials. It is an internationally highly trusted aesthetic choice. Botulinum toxin relaxes muscle; the treatment takes only 10 minutes, achieving wrinkle reduction, facial-shape improvement and facial lifting, and can also provide sweat-reduction treatment for those who perspire heavily.</p>` },
    points: [
  ...
  },
  {
    ...
    bodyHtml: { "zh-HK": `<p>Dysport是歐洲A型肉毒桿菌素，獲美國FDA認證，英國原廠生產，全球被廣泛使用。Dysport可使過度收縮的小肌肉放鬆，達至瘦面、瘦小腿，並可消除皺紋，讓臉部肌膚回復光滑。肉毒桿菌只會在治療部位發生作用，不會影響其他肌肉，效果自然不僵硬。經過十多年的臨床驗證及科研發展，現已獲得60多個國家的授權及註冊，並獲香港衛生署認可。</p>`, "zh-CN": `<p>Dysport是欧洲A型肉毒杆菌素，获美国FDA认证，英国原厂生产，全球被广泛使用。Dysport可使过度收缩的小肌肉放松，达至瘦面、瘦小腿，并可消除皱纹，让脸部肌肤回复光滑。肉毒杆菌只会在治疗部位发生作用，不会影响其他肌肉，效果自然不僵硬。经过十多年的临床验证及科研发展，现已获得60多个国家的授权及注册，并获香港卫生署认可。</p>`, en: `<p>Dysport is a European botulinum toxin type A, certified by the US FDA, manufactured by the original UK factory, and widely used worldwide. Dysport can relax over-contracted small muscles, achieving facial slimming and calf slimming, and can also eliminate wrinkles, restoring smoothness to facial skin. Botulinum toxin acts only at the treated site and does not affect other muscles, so results look natural rather than stiff. After more than ten years of clinical validation and scientific development, it is now authorised and registered in more than 60 countries, and is recognised by the Hong Kong Department of Health.</p>` },
    points: [
  ...
  },
  {
    ...
    bodyHtml: { "zh-HK": `<p>Neauvia Hydro Deluxe冰冰針專有透明質酸技術有效鎖緊肌膚保濕度，塑造柔滑自然肌質，使皮膚表面富彈性，緊緻面部毛孔，提亮亮白膚色。極細的微鈣粒子能滲透肌底，持續刺激自生膠原蛋白，維持長效保濕緊緻作用。</p>`, "zh-CN": `<p>Neauvia Hydro Deluxe冰冰针专有透明质酸技术有效锁紧肌肤保湿度，塑造柔滑自然肌质，使皮肤表面富弹性，紧致面部毛孔，提亮亮白肤色。极细的微钙粒子能渗透肌底，持续刺激自生胶原蛋白，维持长效保湿紧致作用。</p>`, en: `<p>Neauvia Hydro Deluxe Ice Needle uses proprietary hyaluronic acid technology to effectively lock in skin hydration, creating a smooth, natural skin quality, making the skin surface more elastic, tightening facial pores and brightening complexion. Ultra-fine calcium microparticles can penetrate the deeper layers of the skin, continually stimulating the skin’s own collagen production and maintaining long-lasting hydration and firming.</p>` },
    points: [
  ...
  },
  {
    ...
    bodyHtml: { "zh-HK": `<p>Radiesse微晶瓷是生物科技合成的化合物，主結構要由鈣跟磷組成，與人體牙齒及骨骼中的成份相近。Radiesse微晶瓷質地可塑性高且有彈性，塑形即時效果優秀，熱門的塑形部位有額頭、鼻、太陽穴、蘋果肌、法令紋、下巴、手背。</p>`, "zh-CN": `<p>Radiesse微晶瓷是生物科技合成的化合物，主结构要由钙跟磷组成，与人体牙齿及骨骼中的成份相近。Radiesse微晶瓷质地可塑性高且有弹性，塑形即时效果优秀，热门的塑形部位有额头、鼻、太阳穴、苹果肌、法令纹、下巴、手背。</p>`, en: `<p>Radiesse calcium hydroxylapatite is a compound synthesised by biotechnology. Its main structure is composed of calcium and phosphorus, similar to the components of human teeth and bone. Radiesse calcium hydroxylapatite has high mouldability and elasticity, with excellent immediate shaping results. Popular shaping areas include the forehead, nose, temples, apple cheeks, nasolabial folds, chin and the back of the hands.</p>` },
    points: [
  ...
  },
  {
    ...
    bodyHtml: { "zh-HK": `<p>Derma Veil童顏針擁有獨特「3R微分子膠原技術」，深入真皮層，激活強化纖維母細胞生產力，令膠原大量增生，達致再生嫩白膚質、重塑年輕輪廓、自然逆轉肌齡，三大非凡美容效果。Derma Veil童顏針突破性極微細分子，滲透性極強，有效持續延續喚醒膠原自生，由內至外飽滿肌膚，回復皮膚彈性和亮澤度。</p>`, "zh-CN": `<p>Derma Veil童颜针拥有独特「3R微分子胶原技术」，深入真皮层，激活强化纤维母细胞生产力，令胶原大量增生，达致再生嫩白肤质、重塑年轻轮廓、自然逆转肌龄，三大非凡美容效果。Derma Veil童颜针突破性极微细分子，渗透性极强，有效持续延续唤醒胶原自生，由内至外饱满肌肤，回复皮肤弹性和亮泽度。</p>`, en: `<p>Derma Veil baby-face injectable features unique “3R micromolecular collagen technology”. It reaches the dermis, activates and strengthens fibroblast productivity, and drives abundant collagen production, achieving three exceptional aesthetic effects: regenerating and brightening skin quality, reshaping a youthful contour, and naturally reversing apparent skin age. Derma Veil’s breakthrough ultra-fine molecules have exceptionally strong penetration, effectively and continually awakening the skin’s own collagen production, plumping the skin from the inside out and restoring elasticity and radiance.</p>` },
    points: [
  ...
  },
  {
    ...
    bodyHtml: { "zh-HK": `<p>Sculptra®塑然雅®是一種可注射的PLLA聚左乳酸 (Poly-Lactic-Acid)，刺激皮膚底層的膠原蛋白自我增生，改善臉部皮膚及各種皺紋問題。</p>`, "zh-CN": `<p>Sculptra®塑然雅®是一种可注射的PLLA聚左乳酸 (Poly-Lactic-Acid)，刺激皮肤底层的胶原蛋白自我增生，改善脸部皮肤及各种皱纹问题。</p>`, en: `<p>Sculptra® is an injectable PLLA poly-L-lactic acid (Poly-Lactic-Acid) that stimulates the skin’s own collagen production in the deeper layers, improving facial skin and various wrinkle concerns.</p>` },
    points: [
  ...
  },
  {
    ...
    bodyHtml: { "zh-HK": `<p>Ellansé少女針適用於填補肌膚大小凹陷位置，修飾及柔和面部輪廓線，例如是額頭凹陷、眼尾下垂、法令紋、印第安紋、面頰凹陷、下顎線鬆弛等，療程能刺激肌膚膠原新生，自然生成的膠原蛋白持續發揮順滑肌理作用，效果維持可達1-4年。</p>`, "zh-CN": `<p>Ellansé少女针适用于填补肌肤大小凹陷位置，修饰及柔和面部轮廓线，例如是额头凹陷、眼尾下垂、法令纹、印第安纹、面颊凹陷、下颚线松弛等，疗程能刺激肌肤胶原新生，自然生成的胶原蛋白持续发挥顺滑肌理作用，效果维持可达1-4年。</p>`, en: `<p>Ellansé maiden needle is indicated for filling larger and smaller hollows in the skin, and for refining and softening facial contour lines — for example forehead hollows, drooping outer corners of the eyes, nasolabial folds, marionette lines, cheek hollows and jawline laxity. The treatment can stimulate new collagen in the skin; the naturally produced collagen continues to smooth skin texture, with results lasting 1–4 years.</p>` },
    points: [
  ...
  },
  {
    ...
    bodyHtml: { "zh-HK": `<p>AestheFill® 精靈針是新型態的「聚雙旋乳酸 PDLLA」，1:1 左旋+右旋的雙旋結構，提供立即的肌層支撐和生長空間，可長效漸進式地誘導促進皮膚第一型膠原蛋白增生，效果可以維持至少 18–24 個月。主要令肌膚自然豐盈，變得柔軟細膩，重拾年輕。可全面提升額頭、太陽穴、蘋果肌、淚溝、臉頰和法令紋等部位。獲韓國 KFDA 批准銷售、CE Mark 認證，並具香港衛生署表列醫療儀器註冊編號 HKMD NO. 210226。</p>`, "zh-CN": `<p>AestheFill® 精灵针是新型态的「聚双旋乳酸 PDLLA」，1:1 左旋+右旋的双旋结构，提供立即的肌层支撑和生长空间，可长效渐进式地诱导促进皮肤第一型胶原蛋白增生，效果可以维持至少 18–24 个月。主要令肌肤自然丰盈，变得柔软细腻，重拾年轻。可全面提升额头、太阳穴、苹果肌、泪沟、脸颊和法令纹等部位。获韩国 KFDA 批准销售、CE Mark 认证，并具香港卫生署表列医疗仪器注册编号 HKMD NO. 210226。</p>`, en: `<p>AestheFill® sprite needle is a newer form of poly-D,L-lactic acid (PDLLA), with a 1:1 L- and D-lactic dual-helix structure that provides immediate dermal support and space for growth, and can induce Type I collagen production in the skin in a long-acting, progressive way. Results can last at least 18–24 months. It mainly makes the skin naturally fuller, softer and more refined, restoring a youthful look. It can comprehensively lift areas including the forehead, temples, apple cheeks, tear troughs, cheeks and nasolabial folds. It is approved for sale by Korea’s KFDA, holds CE Mark certification, and has Hong Kong Department of Health listed medical device registration number HKMD NO. 210226.</p>` },
    points: [
  ...
  },
  {
    ...
    bodyHtml: { "zh-HK": `<p>全新推出 HArmonyCa™ 美神針™（又名第二代少女針）。獨特配方集合兩大成分：CaHa 微球、透明質酸，突破一般膠原再生療程未見即時效果的限制，拉提緊緻肌膚即時見效，更持續刺激膠原蛋白重組及增生，顯著撫平皺紋，肌膚緊緻效果彷如「液體埋線」般長效自然。療程由知名美國藥廠 Allergan Aesthetics 支持，100% 由醫生主理。</p>`, "zh-CN": `<p>全新推出 HArmonyCa™ 美神针™（又名第二代少女针）。独特配方集合两大成分：CaHa 微球、透明质酸，突破一般胶原再生疗程未见即时效果的限制，拉提紧致肌肤即时见效，更持续刺激胶原蛋白重组及增生，显著抚平皱纹，肌肤紧致效果彷如「液体埋线」般长效自然。疗程由知名美国药厂 Allergan Aesthetics 支持，100% 由医生主理。</p>`, en: `<p>Newly launched HArmonyCa™ Goddess Needle™ (also known as the second-generation “maiden needle”). Its unique formula combines two key ingredients: CaHA microspheres and hyaluronic acid, breaking through the limitation of ordinary collagen-regeneration treatments that lack an immediate effect. Lifting and firming of the skin is visible at once, while it continues to stimulate collagen reorganisation and production, significantly smoothing wrinkles. The skin-firming effect is as long-lasting and natural as a “liquid thread lift”. The treatment is supported by the well-known US pharmaceutical company Allergan Aesthetics, and is 100% physician-led.</p>` },
    points: [
  ...
  },
  {
    ...
    bodyHtml: { "zh-HK": `<p>採用由Gerry Pollock博士研發出「生物共振訊號科技」，有效同時減少內臟脂肪和皮下脂肪，達致顯著的瘦身功效。VG激纖易療程透過精準的能量訊號，一次療程燃燒高達5,000卡路里熱量，發揮非一般肌肉緊緻訓練，減少脂肪同時改善身體線條緊緻度，回復體態輕盈。</p>`, "zh-CN": `<p>采用由Gerry Pollock博士研发出「生物共振讯号科技」，有效同时减少内脏脂肪和皮下脂肪，达致显著的瘦身功效。VG激纤易疗程透过精准的能量讯号，一次疗程燃烧高达5,000卡路里热量，发挥非一般肌肉紧致训练，减少脂肪同时改善身体线条紧致度，回复体态轻盈。</p>`, en: `<p>Using “bio-resonance signal technology” developed by Dr Gerry Pollock, it effectively reduces both visceral fat and subcutaneous fat at the same time, achieving significant slimming results. The VG Easy Slim treatment uses precise energy signals to burn up to 5,000 calories in a single session, delivering exceptional muscle-firming training, reducing fat while improving body-line firmness and restoring a lighter physique.</p>` },
    points: [
  ...
  },
  {
    ...
    bodyHtml: { "zh-HK": `<p>療程採用胸部專屬美容儀，備有多項功能，透過高科技磁頻與超聲波原理，幫助血液循環、疏通經絡，並紓解乳腺結節，從而促進新陳代謝，讓體內毒素加速排走，改善乳腺閉塞的問題，更能收緊胸部肌膚，重塑完美胸形。配合人手按摩將背部及胸部兩側外擴的胸部脂肪集中胸前，提拉胸部肌肉，改善胸部下垂問題，令胸部彈性提升，修復線條及副乳問題，療程後可即時有豐胸效果。</p>`, "zh-CN": `<p>疗程采用胸部专属美容仪，备有多项功能，透过高科技磁频与超声波原理，帮助血液循环、疏通经络，并纾解乳腺结节，从而促进新陈代谢，让体内毒素加速排走，改善乳腺闭塞的问题，更能收紧胸部肌肤，重塑完美胸形。配合人手按摩将背部及胸部两侧外扩的胸部脂肪集中胸前，提拉胸部肌肉，改善胸部下垂问题，令胸部弹性提升，修复线条及副乳问题，疗程后可即时有丰胸效果。</p>`, en: `<p>The treatment uses a breast-dedicated aesthetic device with multiple functions. Through high-technology magnetic frequency and ultrasound principles, it helps blood circulation, opens meridians and relieves mammary nodules, thereby promoting metabolism, accelerating the clearance of toxins from the body, and improving blocked mammary ducts. It can also tighten breast skin and reshape a more ideal breast form. Combined with manual massage, fat that has spread to the back and the sides of the chest is gathered towards the front, lifting the breast muscle, improving sagging, increasing elasticity, and repairing contour and accessory-breast concerns. An immediate breast-enhancement effect can be seen after treatment.</p>` },
    points: [
  ...
  },
  {
    ...
    bodyHtml: { "zh-HK": `<p>微針療法利用天然方法刺激骨膠原增生，而不會破壞皮膚表皮層，從而喚醒及提升肌膚的再生功能，有助淡化皺紋及色斑，改善皮膚質感，調勻膚色及增加皮膚彈性。</p>`, "zh-CN": `<p>微针疗法利用天然方法刺激骨胶原增生，而不会破坏皮肤表皮层，从而唤醒及提升肌肤的再生功能，有助淡化皱纹及色斑，改善皮肤质感，调匀肤色及增加皮肤弹性。</p>`, en: `<p>Microneedling uses a natural method to stimulate collagen production without damaging the epidermis, thereby awakening and enhancing the skin’s regenerative function. It helps fade wrinkles and pigment spots, improve skin texture, even out complexion and increase skin elasticity.</p>` },
    points: [
  ...
  },
  {
    ...
    bodyHtml: { "zh-HK": `<p>睫毛位置擁有大概300至500個毛囊，而且大部分都是處於休眠期，每一個毛囊也有自己不同的生長週期，生長週期總共有3個階段 – 1. 生長期 2. 休眠期 3. 脫落期。孕睫術針對睫毛生長週期進行活化與養護，提升濃密度與立體感。</p>`, "zh-CN": `<p>睫毛位置拥有大概300至500个毛囊，而且大部分都是处于休眠期，每一个毛囊也有自己不同的生长周期，生长周期总共有3个阶段 – 1. 生长期 2. 休眠期 3. 脱落期。孕睫术针对睫毛生长周期进行活化与养护，提升浓密度与立体感。</p>`, en: `<p>The eyelash area has about 300 to 500 follicles, and most of them are in the resting phase. Each follicle has its own growth cycle, with a total of 3 stages — 1. Growth phase 2. Resting phase 3. Shedding phase. Lash-boosting treatment activates and cares for the eyelash growth cycle, improving density and three-dimensional presence.</p>` },
    points: [
  ...
  },
  {
    ...
    bodyHtml: { "zh-HK": `<p>以1064nm波長激光治療，安全性高，治療期間趾甲會有暖熱感覺，激光能穿透厚甲深入趾甲內層（甲板）和甲底下的皮膚（甲床），直擊源頭真菌孢子，大大減低復發機會。大約每4至6星期治療1次，一般3至4次後便會明顯改善，視乎實際情況治療師會提供專業意見。</p>`, "zh-CN": `<p>以1064nm波长激光治疗，安全性高，治疗期间趾甲会有暖热感觉，激光能穿透厚甲深入趾甲内层（甲板）和甲底下的皮肤（甲床），直击源头真菌孢子，大大减低复发机会。大约每4至6星期治疗1次，一般3至4次后便会明显改善，视乎实际情况治疗师会提供专业意见。</p>`, en: `<p>Treated with 1064 nm wavelength laser, with a high safety profile. During treatment the toenail will feel a warm heat. The laser can penetrate thick nail into the inner nail (nail plate) and the skin beneath the nail (nail bed), targeting fungal spores at the source and greatly reducing the chance of recurrence. Treatment is about once every 4 to 6 weeks; clear improvement is generally seen after 3 to 4 sessions. The therapist will provide professional advice according to the actual situation.</p>` },
    points: [
