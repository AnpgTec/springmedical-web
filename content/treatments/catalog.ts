...
export const treatments: Treatment[] = [
  {
    ...
    summary: { "zh-HK": `以單極射頻及超聲波刺激陰道內壁，改善私密肌膚緊緻與健康。`, "zh-CN": `以单极射频及超声波刺激阴道内壁，改善私密肌肤紧致与健康。`, en: `Monopolar RF and ultrasound stimulate the vaginal wall to improve intimate firmness and tissue health.` },
    bodyHtml: { "zh-HK": `<h3>療程介紹</h3><p>BTL Ultra Femme 360 由英國頂尖醫療儀器生產商 BTL 研發，擁有美國 FDA 及歐盟 CE 安全認證，以即棄式治療棒加上單極射頻及超聲波，作 360 度零盲點治療，熱能能傳遞到深層皮下組織層，刺激及促進骨膠原蛋白和彈力蛋白的增生，緊緻陰部之餘，更增加陰部肌肉彈性。</p><h3>療程效果</h3><p>Ultra Femme 360 以單極射頻及超聲波能刺激陰道內壁，刺激膠原蛋白自然增生，陰道壁變厚，改善陰部三大問題，美白外陰變得粉嫩﹑緊緻修形，收緊內陰﹑回復濕潤及彈性，強化骨盤改善尿滲﹑失禁，急救或長期保養皆宜。</p><h3>療程感受</h3><p>療程期間無痛無創，不會造成傷口，只有少量溫熱的感覺。完成首次療程後，膠原已開始增生及變厚，會開始感到陰道內壁感覺已與療程前不同。</p><h3>療程次數</h3><p>治療過程大約需時 8 分鐘，一次已見明顯緊緻效果，建議一年三次，之後再按年齡或情況需要保養。</p><h3>療程優點</h3><p>無創無痛地解決陰部困擾，重拾健康身體和愉快性生活。</p>`, "zh-CN": `<h3>疗程介绍</h3><p>BTL Ultra Femme 360 由英国顶尖医疗仪器生产商 BTL 研发，拥有美国 FDA 及欧盟 CE 安全认证，以即弃式治疗棒加上单极射频及超声波，作 360 度零盲点治疗，热能能传递到深层皮下组织层，刺激及促进骨胶原蛋白和弹力蛋白的增生，紧致阴部之余，更增加阴部肌肉弹性。</p><h3>疗程效果</h3><p>Ultra Femme 360 以单极射频及超声波能刺激阴道内壁，刺激胶原蛋白自然增生，阴道壁变厚，改善阴部三大问题，美白外阴变得粉嫩﹑紧致修形，收紧内阴﹑回复湿润及弹性，强化骨盘改善尿渗﹑失禁，急救或长期保养皆宜。</p><h3>疗程感受</h3><p>疗程期间无痛无创，不会造成伤口，只有少量温热的感觉。完成首次疗程后，胶原已开始增生及变厚，会开始感到阴道内壁感觉已与疗程前不同。</p><h3>疗程次数</h3><p>治疗过程大约需时 8 分钟，一次已见明显紧致效果，建议一年三次，之后再按年龄或情况需要保养。</p><h3>疗程优点</h3><p>无创无痛地解决阴部困扰，重拾健康身体和愉快性生活。</p>`, en: `<p>BTL Ultra Femme 360 is an FDA- and CE-cleared non-invasive treatment using disposable applicators with monopolar RF and ultrasound for 360° coverage. Heat reaches deep tissue to stimulate collagen and elastin, improving firmness, elasticity, lubrication and pelvic support. Sessions take about 8 minutes; often noticeable after one visit, with maintenance as advised.</p>` },
  ...
  },
  {
    ...
    summary: { "zh-HK": `由英國 BTL 研發，超聲波結合單極射頻，專注眼部抗衰。`, "zh-CN": `由英国 BTL 研发，超声波结合单极射频，专注眼部抗衰。`, en: `BTL ultrasound + monopolar RF for non-invasive periocular tightening and rejuvenation.` },
  ...
  },
  {
    ...
    summary: { "zh-HK": `FDA 認證超聲波＋單極射頻，激發膠原自生。`, "zh-CN": `FDA 认证超声波＋单极射频，激发胶原自生。`, en: `FDA-cleared ultrasound + monopolar RF to stimulate natural collagen for facial firming.` },
...
<ul><li>效果可维持约 12 个月，建议每隔 9 个月至 1 年再做一次</li><li>非入侵性，无须恢复期，可即时正常活动</li><li>术后加强保湿与防晒，7 日内暂停含酸类、去角质或美白活性成分的产品</li></ul>`, en: `<p>Thermage FLX is an FDA-cleared non-invasive tightening treatment. Patented monopolar RF with AccuREP™ real-time control delivers 3D volumetric heat into collagen-rich tissue. Dedicated tips treat face/jawline, eyelids and larger body areas. Typically no specific downtime; results may last about 12 months with maintenance as advised.</p>` },
  ...
  },
  {
    ...
    bodyHtml: { "zh-HK": `<p>選擇性地治療位於不同皮層的紅血絲、色素沉積等問題，達到嫩膚的效果，同時溫和保護表層皮膚。獲全球醫界超過十年認證、美國FDA認証，療程高效美肌又安全。</p>`, "zh-CN": `<p>选择性地治疗位于不同皮层的红血丝、色素沉积等问题，达到嫩肤的效果，同时温和保护表层皮肤。获全球医界超过十年认证、美国FDA认证，疗程高效美肌又安全。</p>`, en: `<p>M22 OPT delivers stable square-wave pulses to treat vascular and pigment concerns while protecting the epidermis. FDA-cleared with over a decade of clinical use for efficient, comfortable photorejuvenation.</p>` },
    image: "/images/sig-m22.png",
    faqs: [
...
<ul><li>适用于较脆弱区域</li><li>有助改善表面纹理</li></ul>`, en: `<p>Ultherapy PRIME is an FDA-cleared non-invasive ultrasound lift. DeepSEE™ real-time imaging helps the physician visualise tissue (to about 6 mm) and place micro-focused ultrasound (MFU-V) at the SMAS and dermis to stimulate collagen and elastin. Different transducer depths support SMAS structure, deep dermal firming, and finer work on thinner areas such as around the eyes. Results typically build over weeks to months, with no specific downtime.</p>` },
  ...
  },
  {
    ...
    summary: { "zh-HK": `凹凸洞不是表層色素問題，而是真皮層結構性塌陷——需要精準的修復策略。`, "zh-CN": `凹凸洞不是表层色素问题，而是真皮层结构性塌陷——需要精准的修复策略。`, en: `Ice-pick, boxcar and rolling scars are structural dermal collapse — not surface pigment. We type the scar first, then rebuild with staged combination care.` },
  ...
  },
  {
    ...
    summary: { "zh-HK": `專治反黑、太田痣、牛奶斑等頑固性皮膚色素疾病的最後答案。`, "zh-CN": `专治反黑、太田痣、牛奶斑等顽固性皮肤色素疾病的最后答案。`, en: `A last-resort approach for PIH, nevus of Ota and congenital / stubborn pigment — diagnosis first, then staged combination treatment.` },
  ...
  },
  {
    ...
    summary: { "zh-HK": `針對脫髮、稀疏與頭皮養護的綜合方案。`, "zh-CN": `针对脱发、稀疏与头皮养护的综合方案。`, en: `A comprehensive plan for hair loss, thinning and scalp health with professional assessment.` },
  ...
  },
  {
    ...
    summary: { "zh-HK": `注滲精華技術養護毛囊，對抗各類脫髮問題。`, "zh-CN": `注渗精华技术养护毛囊，对抗各类脱发问题。`, en: `Essence infusion nourishes follicles without damaging hair to counter multiple hair-loss patterns.` },
  ...
  },
  {
    ...
    summary: { "zh-HK": `高純度非動物透明質酸，對應老化、輪廓與面形改善。`, "zh-CN": `高纯度非动物透明质酸，对应老化、轮廓与面形改善。`, en: `High-purity non-animal HA for ageing concerns, contouring and facial shaping.` },
  ...
  },
  {
    ...
    summary: { "zh-HK": `IBSA 專利技術，刺激 12 倍膠原增生，改善鬆弛。`, "zh-CN": `IBSA 专利技术，刺激 12 倍胶原增生，改善松弛。`, en: `IBSA patented high-concentration HA to stimulate collagen and improve laxity.` },
  ...
  },
  {
    ...
    summary: { "zh-HK": `FDA/CE 認證，一次療程效果可維持長達一年。`, "zh-CN": `FDA/CE 认证，一次疗程效果可维持长达一年。`, en: `FDA/CE-cleared HA; results after a first treatment may last up to a year.` },
  ...
  },
  {
    ...
    summary: { "zh-HK": `Merz 藥廠研發，新一代純淨肉毒桿菌，減淡皺紋。`, "zh-CN": `Merz 药厂研发，新一代纯净肉毒杆菌，减淡皱纹。`, en: `Merz purified botulinum toxin to soften moderate-to-deep dynamic wrinkles.` },
  ...
  },
  {
    ...
    summary: { "zh-HK": `FDA 認證，療程只需 10 分鐘，去皺、面形改善、減少流汗。`, "zh-CN": `FDA 认证，疗程只需 10 分钟，去皱、面形改善、减少流汗。`, en: `FDA-cleared toxin for wrinkle relaxation, facial shaping and sweat reduction in ~10 minutes.` },
  ...
  },
  {
    ...
    summary: { "zh-HK": `歐洲 A 型肉毒桿菌素，獲 60 多國授權與香港衛生署認可。`, "zh-CN": `欧洲 A 型肉毒杆菌素，获 60 多国授权与香港卫生署认可。`, en: `European type-A toxin authorised in 60+ countries and recognised by Hong Kong DOH.` },
  ...
  },
  {
    ...
    summary: { "zh-HK": `透明質酸＋微鈣粒子，長效保濕緊緻、提亮膚色。`, "zh-CN": `透明质酸＋微钙粒子，长效保湿紧致、提亮肤色。`, en: `HA plus calcium microspheres for lasting hydration, firmness and brighter tone.` },
  ...
  },
  {
    ...
    summary: { "zh-HK": `鈣磷合成、即時塑形，適用多個輪廓部位。`, "zh-CN": `钙磷合成、即时塑形，适用多个轮廓部位。`, en: `Calcium-phosphate biocompatible filler for immediate contouring across multiple sites.` },
  ...
  },
  {
    ...
    summary: { "zh-HK": `3R 微分子膠原技術，再生嫩白、重塑輪廓、逆轉肌齡。`, "zh-CN": `3R 微分子胶原技术，再生嫩白、重塑轮廓、逆转肌龄。`, en: `3R micro-collagen technology for brighter texture, contour support and gradual rejuvenation.` },
  ...
  },
  {
    ...
    summary: { "zh-HK": `PLLA 聚左乳酸，刺激膠原自我增生，改善皺紋。`, "zh-CN": `PLLA 聚左乳酸，刺激胶原自我增生，改善皱纹。`, en: `Injectable PLLA that stimulates the skin’s own collagen to soften wrinkles.` },
  ...
  },
  {
    ...
    summary: { "zh-HK": `即時填充＋膠原新生，改善凹陷、修飾輪廓。`, "zh-CN": `即时填充＋胶原新生，改善凹陷、修饰轮廓。`, en: `Immediate fill plus collagen renewal for hollows and contour refinement lasting 1–4 years.` },
  ...
  },
  {
    ...
    summary: { "zh-HK": `聚雙旋乳酸 PDLLA，即時支撐＋長效膠原增生。`, "zh-CN": `聚双旋乳酸 PDLLA，即时支撑＋长效胶原增生。`, en: `PDLLA dual-helix structure for immediate support and long-term type-I collagen induction.` },
  ...
  },
  {
    ...
    summary: { "zh-HK": `CaHa 微球＋透明質酸，即時拉提、長效膠原。`, "zh-CN": `CaHa 微球＋透明质酸，即时拉提、长效胶原。`, en: `CaHa microspheres + HA for immediate lift and lasting collagen stimulation.` },
  ...
  },
  {
    ...
    summary: { "zh-HK": `生物共振訊號科技，一次療程燃燒高達 5,000 卡路里。`, "zh-CN": `生物共振讯号科技，一次疗程燃烧高达 5,000 卡路里。`, en: `Bio-resonance signal technology aiming to burn up to 5,000 calories per session.` },
  ...
  },
  {
    ...
    summary: { "zh-HK": `磁頻＋超聲波，改善乳腺閉塞、收緊胸部肌膚。`, "zh-CN": `磁频＋超声波，改善乳腺闭塞、收紧胸部肌肤。`, en: `Magnetic frequency + ultrasound to support circulation, ease congestion and firm breast skin.` },
  ...
  },
  {
    ...
    summary: { "zh-HK": `刺激骨膠原增生，不破壞表皮，淡化皺紋與色斑。`, "zh-CN": `刺激骨胶原增生，不破坏表皮，淡化皱纹与色斑。`, en: `Stimulates collagen without disrupting the epidermis to soften lines and spots.` },
  ...
  },
  {
    ...
    summary: { "zh-HK": `針對睫毛生長週期活化養護，提升濃密度與立體感。`, "zh-CN": `针对睫毛生长周期活化养护，提升浓密度与立体感。`, en: `Activates lash follicles across the growth cycle for denser, more dimensional lashes.` },
  ...
  },
  {
    ...
    summary: { "zh-HK": `1064nm 激光直擊真菌孢子，減低復發機會。`, "zh-CN": `1064nm 激光直击真菌孢子，减低复发机会。`, en: `1064 nm laser targets fungal spores deep in the nail to reduce recurrence.` },
