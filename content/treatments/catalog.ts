...
import { pigmentationBodyHtml } from "./pigmentation-body";
...
<ul><li>Suitable for more delicate areas</li><li>Helps improve surface texture</li></ul>` },
  ...
  },
  {
    ...
    bodyHtml: pigmentationBodyHtml,
    faqs: [
      { q: { "zh-HK": `反黑是什麼？為什麼會發生？`, "zh-CN": `反黑是什么？为什么会发生？`, en: `What is PIH and why does it happen?` }, a: { "zh-HK": `反黑（PIH）是皮膚受刺激後黑色素過度活躍所致，常見於光電療程、煥膚、外傷或日曬後。我們以術前評估、漸進式能量與完整術後修復，協助色素逐步代謝。`, "zh-CN": `反黑（PIH）是皮肤受刺激后黑色素过度活跃所致，常见于光电疗程、焕肤、外伤或日晒后。我们以术前评估、渐进式能量与完整术后修复，协助色素逐步代谢。`, en: `PIH follows overstimulation of melanocytes after energy treatments, peels, injury or sun. We focus on assessment, staged energy and full aftercare.` } },
      { q: { "zh-HK": `太田痣能用普通激光去除嗎？`, "zh-CN": `太田痣能用普通激光去除吗？`, en: `Can ordinary lasers remove nevus of Ota?` }, a: { "zh-HK": `太田痣色素位於真皮深層，表層激光難以觸及。需依病灶深度選擇足夠波長與脈衝參數，並配合冷卻保護與分段治療。`, "zh-CN": `太田痣色素位于真皮深层，表层激光难以触及。需依病灶深度选择足够波长与脉冲参数，并配合冷却保护与分段治疗。`, en: `Pigment sits deep in the dermis; superficial lasers often fail. Depth-matched wavelength, pulse settings and cooling are essential.` } },
      { q: { "zh-HK": `牛奶斑是不是無法處理？`, "zh-CN": `牛奶斑是不是无法处理？`, en: `Are café-au-lait / congenital spots untreatable?` }, a: { "zh-HK": `牛奶斑屬表皮層先天色素，可漸進淡化，但需避免能量過高誘發反黑。若有多發大斑塊，須先排除全身性疾病。`, "zh-CN": `牛奶斑属表皮层先天色素，可渐进淡化，但需避免能量过高诱发反黑。若有多发大斑块，须先排除全身性疾病。`, en: `Epidermal café-au-lait spots can fade gradually with careful energy; multiple large lesions need systemic work-up first.` } },
      { q: { "zh-HK": `治療前會做什麼評估？`, "zh-CN": `治疗前会做什么评估？`, en: `What happens at the first visit?` }, a: { "zh-HK": `包括膚質／影像檢測、病史與過往療程記錄、色素深度與活性評估，以及合理期望與風險說明，再制定個人化參數。`, "zh-CN": `包括肤质／影像检测、病史与过往疗程记录、色素深度与活性评估，以及合理期望与风险说明，再制定个人化参数。`, en: `Skin imaging, history, pigment depth/activity, risk and expectations — then personalised parameters, not a sales pitch.` } }
    ],
  },
  {
    id: "hair-care",
