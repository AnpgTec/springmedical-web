...
export const treatmentCategories: TreatmentCategory[] = [
  {
    ...
    lede: {
      ...
      en: `Selected device and energy treatments for laxity, pigment, texture and intimate repair.`,
    },
  ...
  },
  {
    ...
    lede: {
      ...
      en: `Infusion techniques to nourish follicles and help hair loss and scalp condition.`,
    },
  ...
  },
  {
    ...
    lede: {
      ...
      en: `Hyaluronic acid, botulinum toxin and regenerative injectables, planned after consultation.`,
    },
  ...
  },
  {
    ...
    lede: {
      ...
      en: `Body-focused care supporting contour management and overall anti-ageing.`,
    },
  ...
  },
  {
    ...
    lede: {
      "zh-HK": `日常美容護理與細節改善方案。`,
      "zh-CN": `日常美容护理与细节改善方案。`,
      en: `Everyday beauty care and detail-focused treatments.`,
    },
